...
def update_readme(total: int, protocols: Dict[str, int]):
...
"""
    ...
    update_readme(len(tagged_set), protocol_counts)
    logger.info("✅ Готово.")
...
async def main_async():
    ...
    print("=" * 60)
    print("🚀 LinSpisokObhod (только ALL.txt, без whitelist/cidr)")
    print("=" * 60)
