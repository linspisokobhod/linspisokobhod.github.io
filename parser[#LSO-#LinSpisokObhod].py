...
# === ОСНОВНОЙ СБОР С TCP-ТЕСТИРОВАНИЕМ (ТАЙМАУТ 30 СЕКУНД) ===
        ...
        if unique_endpoints:
            ...
            async def check_endpoint(host, port):
                ...
                async with sem:
                    ...
                    checked_count += 1
                    if checked_count % 10 == 0 or checked_count == total_endpoints:
...
async def main_async():
    ...
    print("=" * 60)
    print("🚀 LinSpisokObhod (финальная версия с заголовками и техподдержкой)")
    print("=" * 60)
